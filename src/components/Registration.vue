...
const signInUser = () =>{
    ...
    localStorage.setItem('email', inputEmailField.value)
    localStorage.setItem('first', inputFirstNameField.value)
    localStorage.setItem('last', inputLastNameField.value)
}
...
<div class=" absolute top-[-40px] w-full h-[1400px]">
